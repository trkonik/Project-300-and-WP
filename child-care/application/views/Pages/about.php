...
<div class="about" id="about">
		<div class="container">
				<h2 class="w3_heade_tittle_agile">Welcome to our Child-Care+</h2>
			<p class="sub_t_agileits">Quality Care For You</p>
			
			<p class="ab">Child care is a place where, we give quality care to the children who suffers from Nutrition</p>

			 <div class="about-w3lsrow"> 
				
				<div class="col-md-6 w3about-img"> 
				    <img src="<?=base_url()?>assets/images/about.jpg" alt=" " class="img-responsive">
				</div> 
				<div class="col-md-6 col-sm-7 w3about-img"> 
					<div class="w3about-text"> 
						...
						<div class="read"><a href="https://en.wikipedia.org/wiki/Health" class="hvr-rectangle-in">Read More</a></div>
					</div>
				</div> 
	...
	<div class="Department_girds_agileits">
		<div class="agile_team_grid">	
					...
					<div class="col-md-3 w3ls_banner_bottom_grid">
						<img src="<?=base_url()?>assets/images/g1.jpg" alt=" " class="img-responsive" />
						<div class="overlay">
							<h4>Department 1</h4>
					...
					<div class="col-md-3 w3ls_banner_bottom_grid">
						<img src="<?=base_url()?>assets/images/g2.jpg" alt=" " class="img-responsive" />
						<div class="overlay">
							<h4>Department 2</h4>
							<ul class="social_agileinfo">
								<li><a href="#" class="w3_facebook"><i class="fa fa-facebook"></i></a></li>
					...
					<div class="col-md-3 w3ls_banner_bottom_grid hvr-shutter-in-horizontal">
						<img src="<?=base_url()?>assets/images/g3.jpg" alt=" " class="img-responsive" />
						<div class="overlay">
							<h4>Department 3</h4>
							<ul class="social_agileinfo">
								<li><a href="#" class="w3_facebook"><i class="fa fa-facebook"></i></a></li>
					...
					<div class="col-md-3 w3ls_banner_bottom_grid">
						<img src="<?=base_url()?>assets/images/g4.jpg" alt=" " class="img-responsive" />
						<div class="overlay">
							<h4>Department 4</h4>
							<ul class="social_agileinfo">
								<li><a href="#" class="w3_facebook"><i class="fa fa-facebook"></i></a></li>
		...
		<div class="menu_w3ls_agile_top_section">
			...
			<div>
				  <div class="w3_agile_recipe-grid">
									...
									<div class="read"><a href="https://en.wikipedia.org/wiki/Dentistry" class="hvr-rectangle-in">Read More</a></div>
								</div>
								<div class="col-md-6 col-sm-6 tab-image two">
									<img src="<?=base_url()?>assets/images/g6.jpg" alt="Medicinal">
								</div>
								<div class="clearfix"></div>
					    </div>
			...
			<div>
			 <div class="w3_agile_recipe-grid">
								...
								<div class="col-md-6 col-sm-6 tab-image">
									<img src="<?=base_url()?>assets/images/g7.jpg" alt="Medicinal">
								</div>
									<div class="col-md-6 col-sm-6 tab-info">
									<h4>Eye</h4>
									<p>Eyes are organs of the visual system. They provide animals with vision, the ability to receive and process visual detail, as well as enabling several photo response functions that are independent of vision. Eyes detect light and convert it into electro-chemical impulses in neurons. In higher organisms, the eye is a complex optical system which collects light from the surrounding environment, regulates its intensity through a diaphragm, focuses it through an adjustable assembly of lenses to form an image, converts this image into a set of electrical signals, and transmits these signals to the brain through complex neural pathways that connect the eye via the optic nerve to the visual cortex and other areas of the brain. Eyes with resolving power have come in ten fundamentally different forms, and 96% of animal species possess a complex optical system.[1] Image-resolving eyes are present in molluscs, chordates and arthropods... </p>
									<div class="read"><a href="https://en.wikipedia.org/wiki/Eye" class="hvr-rectangle-in">Read More</a></div>
								</div>
								<div class="clearfix"></div>
					    </div>
			...
			<div>
				  <div class="w3_agile_recipe-grid">
								...
								<h4>Child care</h4>
									...
									<div class="read"><a href="https://en.wikipedia.org/wiki/Child_care" class="hvr-rectangle-in">Read More</a></div>
								</div>
								<div class="col-md-6 col-sm-6 tab-image two">
									<img src="<?=base_url()?>assets/images/g2.jpg" alt="Medicinal">
								</div>
								<div class="clearfix"></div>
					    </div>
			</div>
...
<div class="service-w3l jarallax" id="service">
	...
	<h3 class="w3_heade_tittle_agile two">What We Do Best</h3>
		<p class="sub_t_agileits">We provide the best services as much as we can.</p>
			...
			<div class="w3layouts-grids">
					...
					<div class="wthree_team_grid1">
						<div class="hover14 column">
							<div>
								<figure><img src="<?=base_url()?>assets/images/t4.jpg" alt=" " class="img-responsive" /></figure>
							</div>
						</div>
				...
				<div class="col-md-3 wthree_team_grid">
					<div class="wthree_team_grid1">
						<div class="hover14 column">
							<div>
								<figure><img src="<?=base_url()?>assets/images/t3.jpg" alt=" " class="img-responsive" /></figure>
							</div>
						</div>
						<div class="wthree_team_grid1_pos">
							<h4>Rosy Carl </h4>
				...
				<div class="col-md-3 wthree_team_grid">
					<div class="wthree_team_grid1">
						<div class="hover14 column">
							<div>
								<figure><img src="<?=base_url()?>assets/images/t2.jpg" alt=" " class="img-responsive" /></figure>
							</div>
						</div>
						<div class="wthree_team_grid1_pos">
							<h4>David Martin</h4>
				...
				<div class="col-md-3 wthree_team_grid">
					<div class="wthree_team_grid1">
						<div class="hover14 column">
							<div>
								<figure><img src="<?=base_url()?>assets/images/t1.jpg" alt=" " class="img-responsive" /></figure>
							</div>
						</div>
						<div class="wthree_team_grid1_pos">
							<h4>Reena Scot</h4>
